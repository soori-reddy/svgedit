export default {
  ...
  properties: {
    ...
    helvetica: 'Helvetica',
    times: 'Times',
    connections_light :"Connections Light Regular",
    toyotatype_semiBold : "Toyotatype SemiBold",
    toyotatype_regular : "Toyotatype Regular",
    toyotatype_light : "Toyotatype Light",
    toyotatype_book : "Toyotatype Book",
    toyotatype_bold : "Toyotatype Bold",
    toyotatype_black : "Toyotatype Black",
    arial : "Arial",
    calibri : "Calibri",
    roman : "Roman",
    time_now_roman : "Times New Roman",
    myriad : "Myriad",
    myriad_semi_bold:"Myriad Semi-Bold",
    inkjet : "Inkjet",
    tt_norms_regular:"TT Norms Regular",
    tt_norms_bold :"TT Norms Bold",
    sans_bold:"Sans Bold",
    sans_bold_italic:"Sans Bold Italic",
    sans_extra_bold:"Sans Extra Bold",
    sans_medium:"Sans Medium",
    effra_heavy:"Effra Heavy",
    prevost_italic: "Prevost Italic",
    prevost_headline_italic: "Prevost HeadlineItalic",
    prevost_headline: "Prevost Headline",
    prevost_bold_italic: "Prevost BoldItalic",
    prevost_bold: "Prevost Bold",
    prevost_regular: "Prevost Regular",
    prevostPPT_roman: "PrevostPPT Roman",
    prevostPPT_italic: "PrevostPPT Italic",
    prevostPPT_bold_italic: "PrevostPPT BoldItalic",
    prevostPPT_bold: "PrevostPPT Bold",
    volvo_novum_light: "Volvo Novum Light",
    volvo_novum_medium: "Volvo Novum Medium",
  ...
  tools: {
    ...
    tool_visibilityrule: 'Visibility Rules',
    fontbackview: 'Front/Back View',
    ...
    enable_shrink : "Enable Shrink to FIt",
    disable_shrink : "Disable Shrink to FIt"
  },
  layers: {
    layer: 'Layer',
    layers: 'Layers',
