 ...
 * @class FrontBackView
 */
export class FrontBackView extends HTMLElement { 
  /**
    ...
    const onClickHandler = (ev) => {
      ...
      switch (ev.target.nodeName) {
        ...
        case 'DIV':
          ...
          break
        case 'IMG':
          if(ev.target.src && ev.target.src.indexOf('frontview.svg') != -1) {
            ev.target.src = './images/backview.svg'
            svgEditor.svgCanvas.setCurrentLayer("back_view")
            svgEditor.svgCanvas.setLayerVisibility("front_view", false)
            svgEditor.svgCanvas.setLayerVisibility("back_view", true)

          } else {
            ev.target.src = './images/frontview.svg'
...
// Register
customElements.define('se-frontbackview', FrontBackView)
