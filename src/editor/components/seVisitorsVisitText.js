...
/**
 * @class VisitorsVisitText
 */
export class VisitorsVisitText extends HTMLElement {
  /**
  ...
  async attributeChangedCallback (name, oldValue, newValue) {
    ...
    switch (name) {
      ...
      case 'customdata':
        ...
        var dataGETURL = getParameterByName('docroot') + '/api/badgedesigner/getVariableTextlist/VisitorsVisits';
        var requestBody = {};
...
// Register
customElements.define('se-visitorsvisittext', VisitorsVisitText)
