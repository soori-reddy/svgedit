 ...
 * @class VisitorText
 */
export class VisitorText extends HTMLElement {
  /**
  ...
  async attributeChangedCallback (name, oldValue, newValue) {
    ...
    switch (name) {
      ...
      case 'customdata':
        ...
        var dataGETURL = getParameterByName('docroot') + '/api/badgedesigner/getVariableTextlist/visitor';
        var requestBody = {};
...
// Register
customElements.define('se-visitortext', VisitorText)
