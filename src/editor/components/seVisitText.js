 ...
 * @class VisitText
 */
export class VisitText extends HTMLElement {
  /**
  ...
  async attributeChangedCallback (name, oldValue, newValue) {
    ...
    switch (name) {
      ...
      case 'customdata':
        ...
        var dataGETURL = getParameterByName('docroot') + '/api/badgedesigner/getVariableTextlist/visit';
        var requestBody = {};
...
// Register
customElements.define('se-visittext', VisitText)
