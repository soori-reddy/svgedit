 ...
 * @class AssetText
 */
export class AssetText extends HTMLElement {
  /**
  ...
  async attributeChangedCallback (name, oldValue, newValue) {
    ...
    switch (name) {
      ...
      case 'customdata':
        ...
        var dataGETURL = getParameterByName('docroot') + '/api/badgedesigner/getVariableTextlist/asset';
        var requestBody = {};
...
// Register
customElements.define('se-assettext', AssetText)
